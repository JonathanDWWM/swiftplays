  ...
  <aside class="app-sidebar">
    ...
    <nav class="app-sidebar-nav">
      <ul class="app-nav-list">
        ...
        <li class="app-nav-item" :class="{ active: currentPath.startsWith('/invitations') }">
          <NuxtLink to="/invitations" class="app-nav-link">
            <span class="app-nav-text">Mes invitations</span>
          </NuxtLink>
        </li>
